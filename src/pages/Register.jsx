...
import { UserPlus, Mail, Lock, User, Eye, EyeOff, ArrowRightLeft } from "lucide-react";
...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      <div className="blob w-96 h-96 bg-purple-500 top-[-100px] left-[-100px]" />
      <div className="blob w-80 h-80 bg-indigo-500 bottom-[-80px] right-[-80px]" />
      ...
      >
        <div className="glass-strong rounded-2xl p-8 shadow-2xl shadow-indigo-500/10">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Get started with CurrencyX</p>
          </div>
